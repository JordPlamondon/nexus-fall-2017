...
function nexus_blog() {
		...
		$labels = array(
			...
			'name_admin_bar'        => __( 'Blog Type', 'text_domain' ),
		...
		$args = array(
			...
			'description'           => __( 'Blog page for nexus website', 'text_domain' ),
			'labels'                => $labels,
		...
		register_post_type( 'nexus_blog', $args );
	
	}
	add_action( 'init', 'nexus_blog', 0 );
 ...
 *
 * @package   Nexus_footer
 * @author    Red Team <dev@redacademy.com
 * @license   GPL-2.0+
 * @link      http://redacademy.com
 * @copyright 2017 Nexus Intercambia
 *
 * @wordpress-plugin
 * Plugin Name:       Nexus Intercambia Footer 
 * Plugin URI:        @TODO
...
class Nexus_footer extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'nexus-footer';

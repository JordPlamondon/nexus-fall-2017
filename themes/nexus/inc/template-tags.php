 ...
 */
 ...
 /**
  * Flush out the transients used in nexus_categorized_blog.
  */
  ...
  */
 function nexus_comment_list( $comment, $args, $depth ) {
  ...
  */
 function nexus_numbered_pagination() {
 	global $wp_query;
 	$big = 999999999;
